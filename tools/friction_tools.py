...
Written for Aalto Advanced Materials Summer School 2012 and modified for
the project course 2014.
...
class FrictionSimulation:
    ...
    def write_velocities_to_file(self, filename='velocities.txt', indices=None, addStepNumber=False):
        ...
        - **Note** Due to a bug/feature in ASE, if you fix the velocities of atoms with 
        :meth:`tools.FrictionSimulation.fix_velocities`, the velocities for these atoms 
        are reported to be 0.0. The method 
        :meth:`tools.FrictionSimulation.gather_average_velocities_during_simulation` 
        does report the correct average velocities for all atoms though.
